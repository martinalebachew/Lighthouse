...
const std::vector<BYTE> KeyV6 = {0xA9, 0x4A, 0x41, 0x95, 0xE2, 0x01,
                                 0x43, 0x2D, 0x9B, 0xCB, 0x46, 0x04,
                                 0x05, 0xD8, 0x4A, 0x21};
...
void AesEncryptCbc(const AesCtx *const Ctx, BYTE *__restrict__ data,
                   size_t *__restrict__ len);
