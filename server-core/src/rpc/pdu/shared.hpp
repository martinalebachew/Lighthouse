...
#define PFC_OBJECT_UUID 0x80     /* if true, a non-nil object UUID was specified in the handle, and is 
                                    present in the optional object field. If false, the object field is omitted. */
