...
std::vector<byte> Conversation::ReceiveFragment(boost::asio::ip::tcp::socket &socket) {
...
std::vector<byte> Conversation::ReceivePDU(boost::asio::ip::tcp::socket &socket) {
...
void Conversation::SendPDU(boost::asio::ip::tcp::socket &socket, std::vector<byte> pdu) {
    // No support for fragmented PDUs
