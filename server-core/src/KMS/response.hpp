...
struct Response {
  ...
  */
  ...
  DWORD Count; // Current activated machines. KMS server counts up to N_Policy
               // << 1 then stops
  DWORD VLActivationInterval; // Time in minutes when clients should retry
                              // activation if it was unsuccessful (default 2
                              // hours)
  DWORD VLRenewalInterval;    // Time in minutes when clients should renew KMS
                              // activation (default 7 days)
  ...
  inline Response(KMS::Request &request) {
