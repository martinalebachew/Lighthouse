...
#define PFC_DID_NOT_EXECUTE                                                       \
  0x20 /* only meaningful on ‘fault’ packet; if true, guaranteed call did not \
          execute. */
#define PFC_MAYBE 0x40 /* ‘maybe’ call semantics requested */
#define PFC_OBJECT_UUID                                                        \
  0x80 /* if true, a non-nil object UUID was specified in the handle, and is   \
          present in the optional object field. If false, the object field is  \
          omitted. */
