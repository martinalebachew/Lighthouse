...
/* 
This file contains definitions for primitive types used by the RPC protocol.
This includes both types defined under C706 §12.6.3.1 Declarations,
and types defined under C706 §14.2 NDR Primitive Types.
*/
