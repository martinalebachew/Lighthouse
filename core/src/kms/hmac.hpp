...
int_fast8_t Sha256Hmac(
  BYTE* key, BYTE* __restrict__ data, DWORD len, BYTE* __restrict__ hmac
) {
  Sha256HmacCtx Ctx;
 ...
 */
static int_fast8_t CreateV6Hmac(
  ...
  FILETIME* ft = (FILETIME*)(responseEnd - V6_POST_EPID_SIZE + sizeof(GUID)
  ); // sizeof(((KMS::Response*)0)->CMID)
